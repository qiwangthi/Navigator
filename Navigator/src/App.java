public class App {
    public static void main(String[] args) throws Exception {
        City ingolstadt = new City("Ingolstadt", 48.764001378240835, 11.42625484665524, null);
        City münchen = new City("München", 48.13891855227781, 11.577266137987793, null);
        City nürnberg = new City("Nürnberg", 49.45061728516064, 11.076253152617218, null);
        City ulm = new City("Ulm", 48.40203485876449, 9.976324958249457, null);
        City stuttgart = new City("Stuttgart", 48.77593813959718, 9.17688481609677, null);
        City augsburg = new City("Augsburg", 48.3684765834842, 10.89671693335146, null);
        City regensburg = new City("Regensburg", 49.01662121288669, 12.092787603517024, null);
        City würzburg = new City("Würzburg", 49.79296114327296, 9.945390533206055, null);
